...
cfg_file="run_scripts/train/regionblip_opt-6.7b_freeze-qformer_regloss_pcqformer_A10040G.yaml"
run_output_dir="training_dir/regionblip_opt-6.7b_freeze-qformer_regloss_pcqformer_A10040G__epoch-${max_epoch}__gpu${nproc_per_node}x4nodes__regloss-${enable_aux_regloss}-${aux_regloss_weight}"
