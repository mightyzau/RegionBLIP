...
cfg_file="run_scripts/train/regionblip_t5-xl_freeze-qformer_regloss_pcqformer_A100.yaml"
run_output_dir="training_dir/regionblip_t5-xl_freeze-qformer_regloss_pcqformer_A100__epoch-${max_epoch}__gpu${nproc_per_node}x4nodes__regloss-${enable_aux_regloss}-${aux_regloss_weight}"
