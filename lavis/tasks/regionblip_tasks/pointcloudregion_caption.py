...
@registry.register_task("pointcloudregion_captioning_refscannet")
class PointcloudRegionCaptionRefScannetTask(BaseTask):
    ...
    def valid_step(self, model, samples):
        ...
        captions = model.generate_pointcloudregion_caption_posembed(
            samples,
    ...
    def _report_metrics(self, eval_result_file, split_name):
        annotation_file = registry.get_path('caption_evaluate_scanrefer_val')
