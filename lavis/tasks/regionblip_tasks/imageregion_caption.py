...
@registry.register_task("imageregion_captioning_refcoco")
class ImageRegionCaptionRefCocoTask(BaseTask):
    ...
    def valid_step(self, model, samples):
        ...
        captions = model.generate_imageregion_caption_posembed(
            samples,
    ...
    def _report_metrics(self, eval_result_file, split_name):
        ...
        annotation_file = registry.get_path('caption_evaluate_refcoco_test')
